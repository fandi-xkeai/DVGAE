...
from utils import *
from preprocess_data import gen_splits, normalize_attributes
...
class DataReader:
    ...
    def get_graph_adj(self):
        self.adj1 = np.array(nx.adjacency_matrix(self.graph).todense())
        self.adj2 = nx.adjacency_matrix(self.graph)
